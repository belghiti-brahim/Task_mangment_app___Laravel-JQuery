                                    ...
                                    <div class=" py-1 my-2">
                                        <div class="mb-5">
                                            <div class="flex items-center">
                                                <div>
                                                    <label for="colorSelected" class="my-2 block text-sm font-medium text-gray-700">Choisir une couleur pour cette responsabilité</label>
                                                    <input id="colorSelected" type="text" placeholder="Pick a color" name="color" value="{{ old('color', $responsibility->color) }}"
